...
namespace SZHome.Common
{
    ...
    public class ImageHandle
    {
        ...
        public static void CutImage(string fromFile,string fileSaveUrl,int x,int y,int width,int height)
        {
            ...
            //截取原图相应区域写入作图区
            graphics.DrawImage(initImage,0,0,new Rectangle(x,y,width,height),GraphicsUnit.Pixel);
            //从作图区生成图片
            Image saveImage = Image.FromHbitmap(bitmap.GetHbitmap());
            //保存图片
            saveImage.Save(fileSaveUrl, ImageFormat.Jpeg);
            //释放资源
            graphics.Dispose();
            initImage.Dispose();
            bitmap.Dispose();
        ...
        public static void CutForCustom(string fromFile, string fileSaveUrl, int maxWidth, int maxHeight, int quality)
        {
            ...
            else
            {
                ...
                else
                {
                  ...
                  //  pickedImage.Save(fileSaveUrl,ImageFormat.Jpeg)
